...
for (int i = 0; i < results.length(); i++) {
    ...
    if (taxon != null) {
        ...
        cientifico =
                taxon.optString("name", "N/A");
        
        genero =
                taxon.optString("genus", "N/A");

        familia =
                taxon.optString("family", "N/A");

        filo =
                taxon.optString("phylum", "N/A");
    ...
    if (fotos != null && fotos.length() > 0) {
        ...
        if (imagenURL != null) {
            imagenURL =
                    imagenURL.replace("square", "medium");
        }
    }
